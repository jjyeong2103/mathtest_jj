...
data_1_7_1 = {
    '과정': [f'$$36MB = 36 \\times 2^{{10}} KB = 36 \\times 2^{{10}} \\times 2^{{10}} B = 36 \\times 2^{{20}} B$$', f'$$2^6x = 2^{{3+3*x}}$$', f'$$6x = 3+3x$$'],
...
data_1_8_2 = {
    '과정': ['$9 \\times 2^{20}$B = $9 \\times 2^{10} \\times 2^10$ B = $9 \\times 2^{10}$KB = 9MB', '따라서 구하는 시간은 $36 \\div 9 $= 4(초)'],
...
st.header("3-3")
st.write("👉**문제** : A \div 3y/2 = 4x^{2}y + 2xy + 6일 때. 다항식 A를 구하시오.")
