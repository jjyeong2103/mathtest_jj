...
st.write("예 : $2^{ 4x } \\times 2^{ 2x } = 2^{ 6x }$")
st.write("$2^{ 6x } = 2^3 + 2^{ 3x }$")
st.write("2-2. 중간에 옮겨적는 과정에서 수나 문자를 잘못 적음")
st.write("예 : $( 2^{4})^{x} \\times ( 2^{2})^{x} = 2^{3} \\times 2^{ 3x }$")
st.write("$2^{ 4x } \\times 2^{ 2x } = 2^3 \\times 2^{x}")
...
st.write("예 : $2^{4} \\times 2^{2} = 2^{3} \\times 2^{3} = 16 \\times 4 = 8 \\times 8$")
st.write("$x = 1$")
...
st.write("예 : ${ 2^6 right }^{x} = 2^{3} \\times 2^{ 3x }$ 이항 $2^{ 3x } = 2^{3}$")
...
st.write("예 : $x$에 1 대입  $2^{ 4 \\times 1 } \\times 2^{ 2 \\times 1}$"
st.write("$2^{6} = 2^{3} \\times 2^{ 3 \\times 1 }$")
st.write("$2^{4} \\times 2^{2} = 2^{6}$")
st.write("$2^{6} = 2^{6}$")
st.write("1")
